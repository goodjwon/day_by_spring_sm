...
public class OrderRepositoryTest {
    ...
    private Book createAndSaveBook(String title, String author, BigDecimal price) {
        Book book = Book.builder()
                ...
                .isbn(ISBN.of("978" + String.format("%010d", (System.nanoTime() % 10000000000L) + (++isbnCounter))))
                .available(true)
    ...
    public void save_신규주문_저장성공() {
        ...
        assertThat(savedOrder.getTotalAmount().getAmount()).isEqualByComparingTo(new BigDecimal("10000"));
    ...
    public void findById_존재하는주문_주문반환() {
        ...
        assertThat(foundOrder.get().getTotalAmount().getAmount()).isEqualByComparingTo(new BigDecimal("10000"));
    }
    ...
    public void findOrderById_존재하는주문_주문직접반환() {
        ...
        // Then
        assertThat(foundOrder).isNotNull();
        assertThat(foundOrder.getTotalAmount().getAmount()).isEqualByComparingTo(new BigDecimal("10000"));
    }
    ...
    class FindByOrderDateBetweenTest {
        ...
        public void findByOrderDateBetween_범위내주문_조회성공() {
            ...
            assertThat(orders).extracting(order -> order.getTotalAmount().getAmount())
    ...
    class FindByTotalAmountBetweenTest {
        ...
        public void findByTotalAmountBetween_범위내주문_조회성공() {
            ...
            assertThat(orders.get(0).getTotalAmount().getAmount()).isEqualByComparingTo(new BigDecimal("50000"));
        }
    ...
    class FindByOrderItemsBookIdTest {
        ...
        public void findByOrderItems_Book_Id_도서포함주문_조회성공() {
            ...
            assertThat(ordersWithTargetBook).extracting(order -> order.getTotalAmount().getAmount())
                    .usingComparatorForType(BigDecimal::compareTo, BigDecimal.class)

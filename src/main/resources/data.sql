...
VALUES (1, 'Clean Code', 'Robert C. Martin', '978-0132350884', 45000, true, CURRENT_TIMESTAMP),
...
VALUES (1, 1, 1, DATEADD('DAY', -5, CURRENT_TIMESTAMP), DATEADD('DAY', 9, CURRENT_TIMESTAMP)),

...
import com.example.spring.application.service.BookServiceImpl;
...
class BookServiceImplTest {
    ...
    class CreateBookTest {
        ...
        void createBook_유효한도서_생성성공() {
            ...
            assertThat(result.getCoverImageUrl()).isEqualTo("https://cdn.example.com/books/clean-code.jpg");
    ...
    class GetBookTest {
        ...
        void getBookByIsbn_존재하는ISBN_조회성공() {
            ...
            // Then
            assertThat(result).isPresent();
            assertThat(result.get().getIsbn().getDigitsOnly()).isEqualTo("9780132350884");
        }
    ...
    class UpdateBookTest {
        ...
        void updateBook_유효한정보_수정성공() {
            ...
            Book expectedSavedBook = Book.builder()
                    ...
                    .author("Robert C. Martin")
                    .isbn(ISBN.of("9780132350884"))
                    .price(Money.of(new BigDecimal("47.99")))
                    .available(true)
                    .coverImageUrl("https://cdn.example.com/books/clean-code-updated.jpg")
                    .createdDate(LocalDateTime.now())
            ...
            assertThat(result.getCoverImageUrl()).isEqualTo("https://cdn.example.com/books/clean-code-updated.jpg");
        }
    ...
    class SearchBookTest {
        ...
        void searchByTitle_유효한제목_검색성공() {
            ...
            given(bookRepository.findByTitleContainingIgnoreCase("Clean")).willReturn(books);
        ...
        void searchByAuthor_유효한저자_검색성공() {
            // Given
            List<Book> books = List.of(savedBook);
            given(bookRepository.findByAuthorContainingIgnoreCase("Martin")).willReturn(books);
        ...
        void searchByKeyword_유효한키워드_검색성공() {
            // Given
            List<Book> books = List.of(savedBook);
            given(bookRepository.findByTitleContainingOrAuthorContaining("Clean")).willReturn(books);
        ...
        void searchBooksWithFilters_복합조건_페이징검색성공() {
            ...
            List<Book> allActiveBooks = List.of(
                    ...
                    Book.builder()
                            ...
                            .price(Money.of(new BigDecimal("48.99")))
                            .available(true)
                            .createdDate(LocalDateTime.now())
                            .build()
            );
        ...
        @Test
        @DisplayName("복합 조건으로 도서 검색 (Specification 버전) - 페이징")
        void searchBooksWithQueryFilters_복합조건_Specification검색성공() {
            // Given
            ...
            Pageable pageable = PageRequest.of(0, 2);
            Page<Book> bookPage = new PageImpl<>(filteredBooks, pageable, 2);

            given(bookRepository.findAll(any(org.springframework.data.jpa.domain.Specification.class), eq(pageable)))
                    .willReturn(bookPage);
            ...
            verify(bookRepository).findAll(any(org.springframework.data.jpa.domain.Specification.class), eq(pageable));
        }

        @Test
        @DisplayName("복합 조건 검색 (Specification 버전) - 조건 없이 전체 조회")
        void searchBooksWithQueryFilters_조건없음_전체조회() {
            // Given
            List<Book> allBooks = List.of(savedBook);
            Pageable pageable = PageRequest.of(0, 10);
            Page<Book> bookPage = new PageImpl<>(allBooks, pageable, 1);
    ...
    class AvailabilityTest {
        ...
        void getBooksByAvailability_재고상태_조회성공() {
            ...
            given(bookRepository.findByAvailable(true)).willReturn(availableBooks);
    ...
    class StatisticsTest {
        ...
        void getTotalBooksCount_전체도서수_반환() {
            // Given
            List<Book> allBooks = List.of(savedBook,
                    Book.builder().id(2L).title("Test").author("Test").isbn(ISBN.of("9781234567890")).price(Money.of(BigDecimal.TEN)).build());

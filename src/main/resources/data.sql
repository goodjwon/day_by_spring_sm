...
VALUES ( 5, '김개발', 'kim.dev@example.com', 'REGULAR', CURRENT_TIMESTAMP),
...
VALUES (6, 5, 6, DATEADD('DAY', -5, CURRENT_TIMESTAMP), DATEADD('DAY', 9, CURRENT_TIMESTAMP)),
...
VALUES (4, 5, 4, DATEADD('DAY', -30, CURRENT_TIMESTAMP), DATEADD('DAY', -16, CURRENT_TIMESTAMP),
